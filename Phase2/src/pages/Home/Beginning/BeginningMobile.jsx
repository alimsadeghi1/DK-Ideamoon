...
import image2 from "../../../assets/images/rocket-site.png";
...
const BeginningMobile = () => {
  ...
  return (
    <div className="position-relative d-lg-none mt-5 pt-lg-5">
      <BeginningStones/>
      <div className="text-center">
        {/*<img
          style={{ width: "115px", height: "265px", objectFit: "cover",  transform: `translateY(-${Math.min(scrollY, 250)}px)`  }}
          src={image2}
          alt=""
        />*/}
      ...
      <div className="text-center home-titles" dir="rtl">
      ایده‌هامون سوخت این موشکه!
      </div>
      {/* <div className="text-center mx-auto" style={{ maxWidth: "300px" }}>
        داستان از این قراره که با ایده‌های هم سوخت موشکون رو جمع کنیم و به ماه
        برسیم و گنج با ارزش ماه رو به دست آوریم
      </div> */}
      <div onClick={onScroll} className="beginning-btn justify-content-center align-items-center mx-auto mt-3">
...
export default BeginningMobile;
